...
const OurServices = () => {
  ...
  return (
    <div className="flex flex-col gap-20 my-20 w-[340px] md:w-[650px] lg:w-[1440px]">
      <div className="animated-service w-[280px] md:w-[600px] lg:w-[1087px]  h-[400px]  lg:h-[550px] bg-white shrink-0 rounded-l-[50px] flex justify-between  md:pl-2 lg:pl-10 py-5 self-end ">
      ...
      <div className="animated-service1 w-[280px] md:w-[600px] lg:w-[1087px]  h-[400px]  lg:h-[550px] bg-white gap-20 rounded-r-[50px] flex justify-between  pl-3 lg:pl-10 py-5">
      ...
      <div className="animated-service w-[280px] md:w-[600px] lg:w-[1087px]  h-[500px]  lg:h-[600px] bg-white shrink-0 rounded-l-[50px] flex justify-between  md:pl-2 lg:pl-10 py-5 self-end ">
        <div className="flex flex-col gap-4 justify-start ml-5">
          ...
          <ul className="lg:w-[339px] lg:h-[203px] shrink-0 text-black text-[14px] lg:text-base not-italic font-normal leading-4 md:leading-5 lg:leading-[30px]">
